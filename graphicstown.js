...
window.onload = function() {
    ...
    var TimeOfDayIndicator = document.createElement("p");
    controls.appendChild(TimeOfDayIndicator)
    ...
    function draw() {
        ...
        TimeOfDayIndicator.innerText = "Time of Day: " + sliders.TimeOfDay.value;
        var sunAngle = Math.PI * (tod-6)/12;
        var sunDirection = [Math.cos(sunAngle),Math.sin(sunAngle),0];
        //var sunDirection = [Math.cos(sunAngle),50,0];
